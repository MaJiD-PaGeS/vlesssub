...
let addressesapi = [
	...
	'https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/api-v6', //IPv6优选内容格式 自行搭建。
];
...
let addressesnotlsapi = [
	'https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/Tls-ip', //可参考内容格式 自行搭建。
];

let DLS = 8;//速度下限
let addressescsv = [
	'https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/addressescsv.csv', //iptest测速结果文件。
];

let subconverter = "apiurl.v1.mk"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/Clash/config/ACL4SSR_Online_Full_MultiMode_DE.ini"; //订阅转换配置文件
...
let CMproxyIPs = [
	...
	{ proxyIP: "oracle.gitgoogle.com", type: "US" },
	{ proxyIP: "collect.gitgoogle.com", type: "JP" },
	{ proxyIP: "workers.cloudflare.cyou", type: "DE" },
	{ proxyIP: "proxyip.fxxk.dedyn.io", type: "US" },
	{ proxyIP: "proxyip.hk.fxxk.dedyn.io", type: "HK" },
	{ proxyIP: "proxyip.fxxk.dedyn.io", type: "US" },
];
let BotToken ='7197829779:AAFrber182_TbdC0cjm-58ThY_bGWsoVwkY';
let ChatID ='821415023'; 
let proxyhosts = [//本地代理域名池
	//'ppfv2tl9veojd-maillazy.pages.dev',
];
let proxyhostsURL = 'https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/proxyhosts';//在线代理域名池URL
let EndPS = 'VPN.CT;//节点名备注内容

let FileName = 'vlesssub';
let SUBUpdateTime = 6; 
let total = 99;//PB
//let timestamp = now;
